...
std::map<int,float> myserialmap = {{1,0},{2,0},{3,0},{4,3.326},{5,3.326},{6,6.472},{7,6.472},{8,6.472},{9,6.472},{10,9.708},{11,9.708},{12,9.708},{13,12.944},{14,12.944},{15,12.944},{16,16.18},{17,16.18},{18,16.18},{19,19.416},{20,19.416},{21,19.416},{22,22.652},{23,22.652},{24,25.888},{25,25.888},{26,29.124},{27,29.124},{28,32.36},{29,32.36},{30,35.596},{31,35.596},{32,38.832},{33,38.832},{34,42.068},{35,42.068},{36,45.068},{37,45.068},{38,48.54},{39,48.54},{40,48.54},{41,0},{42,0},{43,0},{44,3.326},{45,3.326},{46,6.472},{47,6.472},{48,6.472},{49,6.472},{50,9.708},{51,9.708},{52,9.708},{53,12.944},{54,12.944},{55,12.944},{56,16.18},{57,16.18},{58,16.18},{59,19.416},{60,19.416},{61,19.416},{62,22.652},{63,22.652},{64,25.888},{65,25.888},{66,29.124},{67,29.124},{68,32.36},{69,32.36},{70,35.596},{71,35.596},{72,38.832},{73,38.832},{74,42.068},{75,42.068},{76,45.068},{77,45.068},{78,48.54},{79,48.54},{80,48.54}};
...
void Preprocess::rs_handler(const sensor_msgs::PointCloud2::ConstPtr &msg)
{
    ...
    else
    {
      for (int i = 0; i < plsize; i++)
      {
        ...
        int echo=(i+1)/80;
        int number=(i+1)%80;
        double time_pt=(echo*55.552+myserialmap[number])/1e6;
        ...
        added_pt.z = pl_orig.points[i].z;
        added_pt.intensity = pl_orig.points[i].intensity;
        added_pt.curvature = time_pt; //pl_orig.points[i].time/1000;
